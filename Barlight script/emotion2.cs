...
public class emotion2 : MonoBehaviour
{
    ...
    public float ActivePassive { get; private set; }
    public float WarmCool { get; private set; }
    public float HeavyLight { get; private set; }
    public float HardSoft { get; private set; }
    ...
    void Update()
    {
        ...
        ActivePassive = Active_Passive((Texture2D)rawImage.texture, step);
        WarmCool = Warm_Cool((Texture2D)rawImage.texture, step);
        HeavyLight = Heavy_Light((Texture2D)rawImage.texture, step);
        HardSoft = Hard_Soft((Texture2D)rawImage.texture, step);
